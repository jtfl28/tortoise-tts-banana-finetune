...
MODELS = {
    'autoregressive.pth': https://huggingface.co/jtfl28/finetune-tortoise/resolve/main/nnf/models/1000_gpt.pth, #'https://huggingface.co/jbetker/tortoise-tts-v2/resolve/main/.models/autoregressive.pth',
